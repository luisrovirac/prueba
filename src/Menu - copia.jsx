...
export class Menu extends React.Component {
  ...
  <a  ref={homey => { this.myInput = homey; }} className="active" href="#" onClick={this.homex}><i className="fa fa-fw fa-home"></i> Home</a> 
  <a  ref={homey => { this.myInput = homey; }} href="#" onClick={this.playx}><i className="fa fa-fw fa-search"></i> Play</a> 
